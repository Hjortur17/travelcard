<nav>
	<div class="container mx-auto py-4">
		<div class="flex justify-between pt-8">
			<a href="/" class="pl-4 lg:pl-0 xl:pl-0"><p class="text-3xl text-yellow-dark"><i class="far fa-campground"></i></p></a>
			<ul class="list-reset flex items-center">
				...
				{{-- <li class="pr-4 lg:pr-0 xl:pr-0">
					<a class="text-grey-darker hover:text-yellow-dark transition link font-medium" href="/q-and-a">Q&A</a>
				</li>
				<li>
